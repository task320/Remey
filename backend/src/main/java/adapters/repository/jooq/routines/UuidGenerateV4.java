...
public class UuidGenerateV4 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 1714732060;

    /**
     * The parameter <code>remey.uuid_generate_v4.RETURN_VALUE</code>.
     */
    ...
    public UuidGenerateV4() {
        super("uuid_generate_v4", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
