...
public class UuidNsUrl extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -2108717252;

    /**
     * The parameter <code>remey.uuid_ns_url.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsUrl() {
        super("uuid_ns_url", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
