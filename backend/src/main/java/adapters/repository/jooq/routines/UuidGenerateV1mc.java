...
public class UuidGenerateV1mc extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 828295650;

    /**
     * The parameter <code>remey.uuid_generate_v1mc.RETURN_VALUE</code>.
     */
    ...
    public UuidGenerateV1mc() {
        super("uuid_generate_v1mc", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
