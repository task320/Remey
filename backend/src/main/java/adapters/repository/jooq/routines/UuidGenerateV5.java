...
public class UuidGenerateV5 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -942162282;

    /**
     * The parameter <code>remey.uuid_generate_v5.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>remey.uuid_generate_v5.namespace</code>.
     */
    ...
    /**
     * The parameter <code>remey.uuid_generate_v5.name</code>.
     */
    ...
    public UuidGenerateV5() {
        super("uuid_generate_v5", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
