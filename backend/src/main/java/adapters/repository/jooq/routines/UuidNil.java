...
public class UuidNil extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -1467633278;

    /**
     * The parameter <code>remey.uuid_nil.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNil() {
        super("uuid_nil", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
