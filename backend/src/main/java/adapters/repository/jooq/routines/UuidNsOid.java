...
public class UuidNsOid extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -1613007450;

    /**
     * The parameter <code>remey.uuid_ns_oid.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsOid() {
        super("uuid_ns_oid", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
