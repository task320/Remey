...
public class UuidGenerateV1 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 897536438;

    /**
     * The parameter <code>remey.uuid_generate_v1.RETURN_VALUE</code>.
     */
    ...
    public UuidGenerateV1() {
        super("uuid_generate_v1", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
