...
public class UuidNsDns extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -240401528;

    /**
     * The parameter <code>remey.uuid_ns_dns.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsDns() {
        super("uuid_ns_dns", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
