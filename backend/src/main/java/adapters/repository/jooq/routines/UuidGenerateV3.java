 ...
 */
package adapters.repository.jooq.routines;
...
public class UuidGenerateV3 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -143239850;

    /**
     * The parameter <code>remey.uuid_generate_v3.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>remey.uuid_generate_v3.namespace</code>.
     */
    ...
    /**
     * The parameter <code>remey.uuid_generate_v3.name</code>.
     */
    ...
    public UuidGenerateV3() {
        super("uuid_generate_v3", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
