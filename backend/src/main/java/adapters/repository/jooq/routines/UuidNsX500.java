...
public class UuidNsX500 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 766916506;

    /**
     * The parameter <code>remey.uuid_ns_x500.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsX500() {
        super("uuid_ns_x500", Remey.REMEY, org.jooq.impl.SQLDataType.UUID);
