...
public class UserSettings extends TableImpl<UserSettingsRecord> {
    ...
    private static final long serialVersionUID = 2011217195;
     ...
     */
    public final TableField<UserSettingsRecord, String> USERS_ID = createField("users_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
