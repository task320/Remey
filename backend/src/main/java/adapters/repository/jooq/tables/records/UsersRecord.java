...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record5<Integer, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1244058210;
    ...
    /**
     * Setter for <code>remey.users.mail_address</code>.
     */
    ...
    /**
     * Getter for <code>remey.users.mail_address</code>.
     */
     ...
     */
    public UsersRecord(Integer id, String mailAddress, String password, Timestamp createAt, Timestamp updateAt) {
        super(Users.USERS);
