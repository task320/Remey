...
public class Balance extends TableImpl<BalanceRecord> {
    ...
    private static final long serialVersionUID = -2140074143;
     ...
     */
    public final TableField<BalanceRecord, String> USERS_ID = createField("users_id", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
    ...
    /**
     * The column <code>remey.balance.balance_date</code>.
     */
    public final TableField<BalanceRecord, Date> BALANCE_DATE = createField("balance_date", org.jooq.impl.SQLDataType.DATE, this, "");
